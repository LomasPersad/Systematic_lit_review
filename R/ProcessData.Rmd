...
data_r_filtered <- data_r %>% filter(newScore > (22))
...
df$Normalized_Score <- (df$newScore ) / max(df$newScore)
...
df$studyID <- paste(data_r$studyID,'(',data_r$Muscle,',',round(df$Adjusted_Score,1), 'N/cm² )')
