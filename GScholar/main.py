...
def get_papertitle(paper_tag):  
  ...
  for tag in paper_tag:
    title_string=tag.select('h3')[0].get_text()
    title_string=title_string.replace('[HTML]', '')
    title_string=title_string.replace('[PDF]','')
    paper_names.append(title_string)
